...
export function OpenCodeCommandsPanel({ items, saving, onSave, onDelete, onCreate }: OpenCodeCommandsPanelProps) {
    ...
    <div className="flex h-full">
      <div className="w-[220px] flex flex-col border-r border-border/30 shrink-0">
        <div className="px-3 pt-3 pb-2 shrink-0">
          ...
          <p className="text-[10px] text-muted-foreground/40 mt-0.5">OpenCode custom commands</p>
        </div>
        ...
        {selected ? (
          <>
            <div className="rounded-lg border border-border/30 bg-muted/10 px-3 py-2 shrink-0">
              <p className="text-[11px] font-semibold">OpenCode Commands</p>
              <p className="text-[10px] text-muted-foreground/50 mt-1">OpenCode commands are Markdown files with frontmatter. Use <code className="font-mono">description</code>, optional <code className="font-mono">agent</code>, and optional <code className="font-mono">model</code> to define execution context.</p>
            </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                {isDirty ? (
                  <>
                    ...
                    <Button
                      size="sm"
                      onClick={() => onSave(selected.path, buildOpenCodeMarkdown({ description, agent, model }, body))}
          ...
          <div className="flex items-center justify-center h-full text-muted-foreground/20">
            <div className="text-center space-y-2">
              ...
              <p className="text-[10px]">Create an OpenCode command for the selected scope.</p>
            </div>
          </div>
        )}
      </div>
