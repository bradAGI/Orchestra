...
describe('CreateRepoDialog', () => {
  ...
  it('renders description textarea', () => {
    ...
    const textarea = screen.getByPlaceholderText('Repository description (optional)')
  ...
  it('renders Private/Public toggle with Private selected by default', () => {
    ...
    // Private should be visually selected (has primary styling)
    expect(privateBtn.className).toContain('bg-primary')
    expect(publicBtn.className).not.toContain('bg-primary')
  })
  ...
  it('calls onCreate with correct options', async () => {
    ...
    const desc = screen.getByPlaceholderText('Repository description (optional)') as HTMLTextAreaElement
